        ...
        <div className="max-w-2xl pt-10 lg:pt-0">
          ...
          >
            ...
            <h1 className="font-heading text-5xl md:text-7xl font-medium text-brand-dark leading-[1.1] mb-6">
              Rooted in Health. <br className="hidden md:block" />
              <span className="text-brand-primary italic font-subheading">Rich in Flavour.</span>
            </h1>
            <p className="text-lg md:text-xl text-brand-text/80 font-sans mb-10 leading-relaxed max-w-lg">
              Discover premium organic foods made with wholesome ingredients and traditional goodness for modern lifestyles.
            </p>
            
            <div className="flex flex-wrap items-center gap-4">
              <Link href="/products" className="group flex items-center gap-2 bg-brand-primary text-white px-8 py-4 rounded-full font-button text-sm uppercase tracking-wide hover:bg-brand-dark transition-all duration-300 shadow-[0_10px_30px_rgba(184,148,95,0.3)] hover:shadow-[0_15px_35px_rgba(110,84,50,0.4)]">
                Shop Products
                <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
              </Link>
              <Link href="/products" className="flex items-center gap-2 px-8 py-4 rounded-full font-button text-sm uppercase tracking-wide text-brand-dark border border-brand-border hover:border-brand-primary hover:text-brand-primary transition-colors bg-white/30 backdrop-blur-sm">
                Explore Categories
              </Link>
            </div>
          </motion.div>
        ...
        <div className="relative h-[400px] lg:h-[600px] mt-12 lg:mt-0">
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="font-heading font-bold text-brand-dark">100% Natural</p>
                <p className="text-xs font-sans text-brand-text">Pure Nutrition</p>
              </div>
            </div>
          </motion.div>
        </div>
